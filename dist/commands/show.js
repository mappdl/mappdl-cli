...
let AppShowCommand = class AppShowCommand extends commandline_1.AppCommand {
    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            const app = this.app;
            try {
                const appDetailsResponse = yield interaction_1.out.progress("Getting app details ...", client.apps.get(app.ownerName, app.appName));
                format_app_1.reportApp(appDetailsResponse);
            }
            catch (error) {
