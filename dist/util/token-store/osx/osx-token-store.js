...
const debug = require("debug")("mappdl-cli:util:token-store:osx:osx-token-store");
const util_1 = require("util");
const securityPath = "/usr/bin/security";
const serviceName = "mappdl-cli";
...
class OsxTokenStore {
    ...
    set(key, value) {
        const args = ["add-generic-password", "-a", key, "-D", "mappdl cli password", "-s", serviceName, "-w", value.token, "-U"];
        if (value.id) {
