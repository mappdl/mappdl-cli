...
import { MappDLClientOptionalParams } from "./models";
import { codePushDeploymentFileUploadImpl } from "./operations/codePushDeploymentFileUpload";

export class MappDLClient extends coreClient.ServiceClient {
  $host: string;
   ...
   */
  constructor(options?: MappDLClientOptionalParams) {
    // Initializing default values for options
    if (!options) {
      options = {};
    }
    const defaults: MappDLClientOptionalParams = {
    ...
    const optionsWithDefaults = {
      ...
      endpoint:
        options.endpoint ?? "https://api.mappdl.com"
    };
    ...
    this.codePushDeploymentFileUpload = new codePushDeploymentFileUploadImpl(this);
  ...
  codePushDeploymentFileUpload: CodePushDeploymentUpload;
